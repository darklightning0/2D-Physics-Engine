...
public:
    ...
    inline RevoluteJoint& createRevoluteJoint(Object& objA, Object& objB, const Vector& localAnchorA, const Vector& localAnchorB, float biasFactor = 0.2f, float softness = 0.f);
    ...
    inline const std::vector<RevoluteJoint*>& getRevoluteJoints() const;
