...
Object& World::createRectangle(World& world, float width, float height, Vector position, float density, float mass, float restitution, sf::Color color, bool isStatic){
    ...
    Object* RectObject = new Object(0, width, height, position, density, mass, restitution, RectShape, color, isStatic, 1);
...
Object& World::createCircle(World& world, float radius, Vector position, float density, float mass, float restitution, sf::Color color, bool isStatic){
    ...
    Object* CircObject = new Object(radius, 0, 0, position, density, mass, restitution, CircShape, color, isStatic, 0);
...
void World::update(float stepTime){
